...
We recommend using [commitizen](github.com/commitizen-tools/commitizen) to compose commits.
...
# Branching / Git flow
We follow GitHub Flow (short-lived feature branches merged into `master` via PRs). See [GitHub’s documentation](https://docs.github.com/en/get-started/using-github/github-flow) for details.
...
8. Run the checks and fix issues.
